...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='D:/Projects/ai-nst-project/Neural-Style-Transfer(NST)/content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='D:/Projects/ai-nst-project/Neural-Style-Transfer(NST)/style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='D:/Projects/ai-nst-project/Neural-Style-Transfer(NST)/vgg_normalised.pth',
...
def main():
    ...
    for batch in style_dataloader:
        print('Style batch shape: ', batch.shape)
